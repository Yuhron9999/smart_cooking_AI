...
public interface RecipeRepository extends JpaRepository<Recipe, Long> {
    ...
    /**
     * Count recipes by author after specific date
     */
    long countByAuthorAndCreatedAtAfter(User author, LocalDateTime date);

    /**
     * Find recipes by author ordered by created date descending
     */
