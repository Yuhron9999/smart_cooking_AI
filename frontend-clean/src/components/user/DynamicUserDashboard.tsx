...
const DynamicUserDashboard: React.FC = () => {
    ...
    const handleProfileUpdate = async () => {
        try {
            ...
            setUserData((prev: UserData | null) => prev ? { ...prev, profileData: updatedProfile } : null);
            setEditMode(null);
        } catch (error) {
    ...
    const handlePreferencesUpdate = async () => {
        try {
            ...
            setUserData((prev: UserData | null) => prev ? { ...prev, preferences: updatedPreferences } : null);
            setEditMode(null);
        } catch (error) {
    ...
    const addCuisinePreference = async (cuisine: string) => {
        try {
            ...
            setUserData((prev: UserData | null) => prev ? { ...prev, cuisinePreferences: updatedCuisines } : null);
        } catch (error) {
    ...
    const updateDietaryRestrictions = async (restrictions: DietaryRestriction[]) => {
        try {
            ...
            setUserData((prev: UserData | null) => prev ? { ...prev, dietaryRestrictions: updatedRestrictions } : null);
        } catch (error) {
        ...
        <div className="space-y-4">
            <div>
                ...
                <input
                    ...
                    onChange={(e) => setProfileForm((prev: any) => ({ ...prev, displayName: e.target.value }))}
            ...
            <div>
                ...
                <select
                    ...
                    onChange={(e) => setProfileForm((prev: any) => ({
                        ...prev,
    ...
    const CuisinePreferences = () => (
        <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-2">
                {userData?.cuisinePreferences.map((cuisine: string) => (
                    <span
                        key={cuisine}
            ...
            <Card>
                ...
                <CardContent>
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                        {userData.createdRecipes.slice(0, 6).map((recipe: any) => (
                            <div
                                key={recipe.id}
